...
int score = 0;
	QuizGameFunctions function = new QuizGameFunctions();
	...
	while (true){
		...
		System.out.printf("Hi, Welcome to MXR's quiz game. You would be asked random questions, you can quit anytime...%n%n%n");
		while(true){
		int questionNumber = function.generateRandomNumber();
		System.out.print(function.returnQuestion(questionNumber));
		char userAnswer = input.next().charAt(0);
		function.checkIfUserInputIsCorrect(questionNumber, userAnswer);
		}
